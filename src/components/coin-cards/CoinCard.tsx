...
const containerVariants = {
    hidden: { opacity: 0, y: 59 , scale: 0.90 },
    visible: {
        opacity: 1,
        y: 0,
        scale: 1,
...
export default function CoinCard({ tag, icon, isLoading, list }: Props) {
    return (
        <div className="relative w-full h-85 rounded-2xl bg-white/10 backdrop-blur-md border border-white/10 text-white transition-all duration-300 py-5 flex items-start justify-start flex-col">
