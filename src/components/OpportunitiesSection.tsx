...
export default function OpportunitiesSection() {
    return (
        <div className="w-full flex items-center justify-center">
            <div className="w-custom flex items-center justify-center flex-col gap-3">
                ...
                <TitleAnimation text="TRADE YOUR FAVOURATE MARKETS" animatedTexts={["FAVOURATE"]} coloredTexts={["TRADE"]} className="text-[30px] text-white font-inter-bold mt-1" />
                <TextSplitAnimation text="Want to buy Bitcoin outright or trade CFDs on Gold or EUR/USD? We've got you covered with access to 100+ global markets on one platform." className="text-gray-400 text-md w-[53%]" />
