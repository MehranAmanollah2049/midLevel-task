    ...
    return (
        <div className="w-full flex items-center justify-center">
            <div className="w-custom flex items-center justify-center flex-col gap-3 relative">
                ...
                <TitleAnimation text="TRADE YOUR FAVOURATE MARKETS" animatedTexts={["FAVOURATE"]} coloredTexts={["TRADE"]} className="w-full text-[26px]/8 min-[370px]:text-[28px]/9 min-[400px]:text-[31px]/9 min-[432px]:text-[34px]/10 min-[470px]:text-[36px]/10 min-[800px]:text-[35px] text-white font-inter-bold mt-1 text-center" />
