    ...
    return (
        <div className="w-full flex items-center justify-center">
            <div className="w-custom flex items-center justify-center flex-col gap-3 relative">
                ...
                <TitleAnimation text="TRADE YOUR FAVOURATE MARKETS" animatedTexts={["FAVOURATE"]} coloredTexts={["TRADE"]} className="text-[29.5px]/9 min-[395px]:text-[33px]/10 min-[800px]:text-[35px] text-white font-inter-bold mt-1 text-center" />
